...
$orderSql = "SELECT FaeTag,type,brand,model,emplacement,serial,image,Etat FROM matériel ";
	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
			 ...
			 <!-- /Search Button -->
				<form action="" method="GET"> 
				 <div class="search">
					<input  type="text" class="searchTerm" name="search" value="<?php ?>" placeholder="Entrez un FaeTag  ou Serial ... ">
		  ...
		  <!--end search bar -->
				...
				<table class="table table-hover table-striped table-bordered" id="manageProductTable">
					...
					?>
						<tr>
							...
							<td><?php if( $orderResult['Etat']==0){echo "neuf";}else{echo "réparé";}?></td>
			...
			</div> <!-- /panel-body --><?php }else{
				$v=$_GET['search'];
				$searchSql = "SELECT FaeTag,type,brand,model,emplacement,serial,image,Etat FROM matériel where  FaeTag='".$v."' or serial='".$v."'";
				$sQuery = $connect->query($searchSql);
				if(empty($orderResult = $sQuery->fetch_assoc())){
				?>
					<html>
					<head>
			...
			?>
             ...
             <table class="table table-hover table-striped table-bordered" id="manageProductTable">
					...
					$sQuery->data_seek(0);
					while ($orderResult = $sQuery->fetch_assoc()) {
						
					?>
						<tr>
						    <td><?php echo"yes";  echo '<img src="'. $orderResult['image'] .'" width="98" height="68"/></a>'?></td>
							<td><?php echo $orderResult['FaeTag']?></td>
							<td><?php echo $orderResult['type']?></td>
							<td><?php echo $orderResult['brand']?></td>
							<td><?php echo $orderResult['model']?></td>
